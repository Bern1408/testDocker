...
class CalculateurPrixTest extends TestCase
{
     ...
     */
    public function test_calcul_prix__avec_taxe_standard(): void
    {
        // / Arrange
    ...
    public function test_remise_negative_exception(): void
    {
        $calculateur = new CalculateurPrix;
        $this->expectException(\InvalidArgumentException::class);
        $calculateur->appliquerRemise(100.00, -0.15);
    }

    public function test_seuil_negatif_exception(): void
    {
        $calculateur = new CalculateurPrix;
        $this->expectException(\InvalidArgumentException::class);
        $calculateur->respecteSeuilMinimum(100.00, -0.15);
    }
